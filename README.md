...
**By Alexandra Holcombe && Kaz Matthws**  
Webpage built with .NET Core using Entity Framework migrations, SQL Server.  Two-day project practicing migrations for Week 1 of Epicodus .NET curriculum.
